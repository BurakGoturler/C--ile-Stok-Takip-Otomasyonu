...
namespace stok_takip_01_08_2022
{
    public partial class ÜrünSil : Form
    {
        ...
        {}
        private void btnGüncelle_Click(object sender, EventArgs e) //Butonunun işlevi silme.
        {
            ...
            else
            {
                ...
                MessageBox.Show("Ürün Stok'tan başarıyla silindi", "Bilgilendirme", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
